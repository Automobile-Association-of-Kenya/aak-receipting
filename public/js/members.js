(function () {
        ...
        $.getJSON("/members-data", function (customers) {
            ...
            $.each(customers, function (key, value) {
                let firstName = value.firstName === null ? "" : value.firstName,
                    secondName =
                        value.secondName === null ? "" : value.secondName,
                    surNameName =
                        value.surNameName === null ? "" : value.surNameName,
                    MembershipNumber =
                        value.MembershipNumber === null
                            ? ""
                            : value.MembershipNumber;
                tr += `<tr><td>${i++}</td><td><small>${MembershipNumber}</small></td><td><small>${
                    firstName + " " + secondName + " " + surNameName
    ...
    const corporateCreateForm = $("#corporateCreateForm"),
