        ...
        <main class="content-wrapper mt-5">
            <div class="row w-100">
                <div class="col-md-4 left-half">
                    <h1 class="center" style="font-weight:800; color:rgba(2, 79, 49, 0.85);">Sign Up</h1>
                    <h6 class="signup-link"><a href="loginSalesCode">Already Registered? Login</a></h6>
                </div>
                    ...
                    <div class="form-container col-md-7">
                        ...
                        <form action="/signup" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="salescode" name="salescode">
                            </div>
                            <div class="form-group">
